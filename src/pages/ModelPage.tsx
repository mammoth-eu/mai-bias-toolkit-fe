...
import FeaturesAndProtectedCharacteristicsStep
    from "../components/business/model-steps/FeaturesAndProtectedCharacteristicsStep";
import ModelParametersVisualizationStep from "../components/business/model-steps/ModelParametersVisualizationStep";
...
const ModelPage = () => {
    ...
    const stepMarkers = () => {
        ...
        markers.push(<MultistepMarker step={index++} title="Model Parameters Visualization"/>);
    ...
    const handleSubmitStep5 = (event: any) => {
        event.preventDefault();
        navigate("/runs");
        return Promise.resolve(() => {
            return true;
    ...
    const stepActions = () => {
        ...
        actions.push(handleSubmitStep5);
        return actions;
    };
