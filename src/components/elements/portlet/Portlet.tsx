        ...
        <div className="portlet has-background-white has-radius has-shadow-normal" style={style}>
            {(!!title || !!actions) &&
                <div className="p-header">
                    {!!title &&
                        <div className="title is-size-5-touch is-size-4-desktop">{title}  {subtitle &&
                            <span className="subtitle has-text-weight-normal has-text-grey">({subtitle})</span>}
                        </div>}
                    {!!actions && <div className="actions is-flex is-justify-content-center">
                        {actions}
                    </div>}
                </div>}
            ...
            {!hideFooter && !!footer && <div className="p-footer">
                <div className="left"/>
