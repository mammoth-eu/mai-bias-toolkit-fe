...
const UserControlPanel: React.FC<Props> = React.memo(({children}) => {
    ...
    return (<>
        <div className="columns is-centered mx-1">
            <div className={"column is-narrow has-background-sidebar mb-3 px-0 has-text-centered"}
                 style={isTablet() ? {} : {minHeight: "85vh"}}>
                <aside className="menu mt-3">
                    <ul className="menu-list">
                        <li>
                            <SideNavigationItem to="/"
                                                path={pathname}
                                                icon={faHouse}
                                                tooltip="Dashboard"
                                                showFull={isTablet()}/>
            ...
            <div className="column mr-2 mb-2">
                {children}
            </div>
        </div>
    </>)
